...
class ShowStoryWithout extends StatefulWidget {
  final Story story;

  const ShowStoryWithout({Key key, @required this.story}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _ShowStoryWithoutState();
}

class _ShowStoryWithoutState extends State<ShowStoryWithout> {
